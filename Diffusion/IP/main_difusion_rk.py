...
for k in range(1,n_step_time):
    ...
    for j in range(0,or_RK):
        ...
        for i in range(1,size_of_domaine-1):
            ...
            all_flux_point_array_u_eq[i*(deg+2)-1] = IP_continuity_u(flux_left_u,flux_right_u);
            all_flux_point_array_u_eq[i*(deg+2)] = IP_continuity_u(flux_left_u,flux_right_u);
        ...
        for i in range(1,size_of_domaine-1):
            ...
            IP_continuity_s(grad_left_u,grad_right_u,flux_left_u,flux_right_u,eta,);
